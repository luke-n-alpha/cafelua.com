...
<form name="write" method="post" action="member_join_ok.php" enctype="multipart/form-data" onsubmit="return check_submit();"><input type="hidden" name="PHPSESSID" value="f09565d4706e3c3da7ad2dea14a8e7e9" />
...
<input type="hidden" name="group_no" value="2">
  ...
  <tr align=right>
     <td width=25% height=45 style=font-family:Tahoma;font-size:8pt;><b>ID&nbsp;</td>
...
<tr height=30 bgcolor=#ffffff>
   ...
   <input type="image" border="0" src="images/button_join.gif?PHPSESSID=f09565d4706e3c3da7ad2dea14a8e7e9"> &nbsp;
