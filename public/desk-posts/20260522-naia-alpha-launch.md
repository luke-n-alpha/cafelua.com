...
이번에 만든 회사, Nextain은 제가 만든 첫 회사는 아닙니다. 이전에 운영하던 'Belivvr'를 폐업했고, 그 고통스러운 마무리의 과정을 다시 한번 SW개발자의 역할로 돌아가 Cursor와 함께 1년간 혼자 Belivvr의 코드를 다듬으며 정리해 왔습니다. 그 힘든 와중에 다시 처음 컴퓨터를 만났을 때의 꿈을 다시 꺼내보게 됐습니다.
...
지금 말씀드린 것들은 개념이 아니라, 모두 실제로 만들고 있는 결과물들입니다.
