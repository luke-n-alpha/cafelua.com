  ...
  en: {
    translation: {
      ...
      "library": {
        ...
        "alphaIntro": "Welcome, Guest.\nWelcome to Cafe Lua.\nThis is Luke's library.\nTurn on the old PC to explore Luke's restored homepages from 1997, 1998, and fstory.net (2001–2003).",
        "start": "Start",
        "close": "OK"
      },
      "season": {
